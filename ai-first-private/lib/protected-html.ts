...
function rewriteHtml(html: string): string {
  const privateNav = [
    ...
    '<a style="color:#f4f2ec;text-decoration:none" href="/checklist">Checklist</a>',
    '<a style="color:#a4a6b5;text-decoration:none" href="/programa-ai-first">Programa</a>',
    '<a style="color:#a4a6b5;text-decoration:none" href="/pre-curso-ai-first">Pré-curso</a>',
    "</span>",
    "</div>",
    "</div>"
  ].join("");
